...
<head>
    ...
    <meta name="description"
        content="Upload a photo, let AI detect the vibe, and get a personalized Spotify playlist instantly.">
    ...
    <div class="page-wrapper">
        ...
        <nav>
            ...
            <div class="nav-actions">
                ...
                @else
                    <a href="{{ route('auth.spotify') }}" class="btn-spotify">
        ...
        <section class="hero">
            ...
            <p class="hero-sub">
                Upload any photo. Our AI reads the mood, energy, and emotion — then crafts a perfectly matched Spotify
                playlist. Instantly.
            </p>
            ...
            <div class="hero-cta">
                ...
                @else
                    <a href="{{ route('auth.spotify') }}" class="btn-cta-spotify">
        ...
        <section class="section" id="how-it-works">
            ...
            <div class="steps-grid">
                ...
                <div class="step-card" style="--glow-color: rgba(29,185,84,0.12)">
                    ...
                    <div class="step-icon">🎧</div>
                    <div class="step-h">Spotify Playlist Created</div>
                    <p class="step-p">A curated playlist lands directly in your Spotify library, ready to listen with a
                        single tap.</p>
                </div>
            </div>
        </section>
        ...
        <section class="cta-section">
            <div class="cta-inner">
                ...
                <p>Connect Spotify for free and generate your first playlist in under 30 seconds.</p>
                @auth
        ...
        <footer>
            <p>© 2026 VibeCraft · Built with Laravel + AI · <a href="{{ route('auth.spotify') }}"
                    style="color:var(--green);text-decoration:none;">Connect Spotify</a></p>
        </footer>
    </div>
</body>
